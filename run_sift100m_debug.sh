...
mkdir -p SIFT100M16384M32_DIR/DPU_DIR \
         SIFT100M16384M32_DIR/CPU_DIR \
         SIFT100M16384M32_DIR/BATCH_DPU_DIR
...
LOG_PATH="/home/dlrkdals/PIM-ANNS/log/pim-anns-nprobe${NPROBE}.stderr.log"
