...
mkdir -p MSMARCO138M65536M128_DIR/DPU_DIR \
         MSMARCO138M65536M128_DIR/CPU_DIR \
         MSMARCO138M65536M128_DIR/BATCH_DPU_DIR \
         log

cp "$SCRIPT_DIR/msmarco138M-65536-128.json" "$SCRIPT_DIR/config.json"
...
LOG_PATH="/home/dlrkdals/PIM-ANNS/log/pim-anns-msmarco138m-nprobe${NPROBE}.stderr.log"
echo "stderr log: ${LOG_PATH}"
echo "coroutine stack: ${PIM_ANNS_COROUTINE_STACK_SIZE}"
echo "config: $SCRIPT_DIR/config.json -> msmarco138M-65536-128.json"
